...
export const Testimonials = () => {
  ...
  return (
    <div className="bg-gray-950 py-20">
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6 px-6 mb-16">
        <div className="bg-gray-900 p-6 rounded-xl border border-gray-700">
          <p className="text-gray-300">
            “Believe me that TheFitSteph live workout is fire and better than
        ...
        <div className="bg-gray-900 p-6 rounded-xl border border-gray-700">
          <p className="text-gray-300">
            “Today was explosives. The workouts and the prayer session today was
